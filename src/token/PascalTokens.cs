...
namespace Pascal
{
    ...
    public class PascalTokens
    {
        ...
        public static readonly int POINTER = ++tokType;
        public static readonly int DEREFERCING = ++tokType;
        ...
        //researve symbols
        public static readonly Token TPOINTER = new Operator("^", POINTER);
        public static readonly Token TDEREFERCING = new Operator("@", DEREFERCING);
